...
//		logger.debug("StatisticsBottleContoller getProductPriceSeq "+ params.getProductPriceSeq());
		...
		String toDay = DateUtils.getNextDate(0,"yyyy/MM/dd");
		if(searchStatDtEnd.equals(toDay)) {
			StatisticsBottleVO statToday = statService.getTodayStatisticsBottleListNew(params); 
			mav.addObject("statToday", statToday);	
		}
		//검색어 셋팅
		mav.addObject("searchStatDt", searchStatDt);		
	...
	@RequestMapping(value = "/gms/statistics/bottle/excelDailyNew.do")
	public void excelDownloadBottleNew(HttpServletResponse response, StatisticsBottleVO params){
	// 게시판 목록조회
	   ...
	   try {
		   ...
		   // 날짜,입고,충전,판매,회수,폐기
			...
			if(searchStatDtEnd.equals(toDay)) {
		        ...
		        cell = row.createCell(0);
		        cell.setCellStyle(bodyStyle);
		        cell.setCellValue(statToday.getStatDt());
		        
		        cell = row.createCell(1);
		        cell.setCellStyle(bodyStyle);
		        cell.setCellValue(statToday.getBottleInputCount());
		        
		        cell = row.createCell(2);
		        cell.setCellStyle(bodyStyle);
		        cell.setCellValue(statToday.getBottleChargeCount());
		        
		        cell = row.createCell(3);
		        cell.setCellStyle(bodyStyle);
		        cell.setCellValue(statToday.getBottleSalesCount());
		        
		        cell = row.createCell(4);
		        cell.setCellStyle(bodyStyle);
		        cell.setCellValue(statToday.getBottleRentalCount());
		        
		        cell = row.createCell(5);
		        cell.setCellStyle(bodyStyle);
		        cell.setCellValue(statToday.getBottleBackCount());
			}
